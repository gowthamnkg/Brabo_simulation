...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamic_angle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gowtham/Documents/temp_ws/install/${idir}'.  Ask the maintainer 'gowtham <gowtham@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/gowtham/Documents/temp_ws/install/lib;/opt/ros/indigo/lib)
